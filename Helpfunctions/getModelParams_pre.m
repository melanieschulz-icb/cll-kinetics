function [modelParams] = getModelParams_pre(patients, inputFolder, models,pre_models,sheet)
%getModelParams
...
%           -> One table containing the params of all patients/models
    ...
    for patient=patients
        ...
        for model=models
            for pre_model=pre_models
                preModel_params=par_table(par_table.model_pre==pre_model,:);
                modelPatParams=preModel_params(preModel_params.model==model,:);
